...
class Article(models.Model):
    ...
    content = UEditorField(width=900, height=300, toolbars="full", imagePath="images/", filePath="files/",upload_settings = {"imageMaxSize": 1204000},settings = {}, verbose_name = '内容')
...
class Comment(models.Model):
    content = UEditorField(width=900, height=300, toolbars="full", imagePath="images/", filePath="files/",upload_settings = {"imageMaxSize": 1204000},settings = {}, verbose_name = '评论内容')
